...
3. Ask focused questions when requirements, constraints, or expected behavior are unclear. Record the questions in the Issue Tracker, move the story to `AI Decomposition review`, and stop until they are answered.
...
10. Move the story to `AI Decomposition review` so a human can review the plan.
