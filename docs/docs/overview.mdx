...
Codee uses AI agents such as Claude Code, GitHub Copilot, Codex and OpenCode. It does not try to reinvent what they already do best: working with code, context management, MCP and other things. At its core, Codee has a [skills](https://agentskills.io) system.
